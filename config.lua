...
-- Want to give out a lockpick per stop?
Config.Givelockpick = true


-- Has to roll this number or higher to receive a lockpick
Config.lockpickChance = 75
...
Config.Peds = {
    {
        model = 's_m_y_garbage',
        coords = vector4(892.41, -2172.31, 31.29, 174.23),
...
Config.Locations = {
    ["main"] = {
        label = "Garbage Depot",
        coords = vector3(878.81, -2175.76, 30.52),
    },
    ["vehicle"] = {
        label = "Garbage Truck Storage",
        coords = { -- parking spot locations to spawn garbage
            [1] = vector4(878.81, -2175.76, 30.52, 169.99),
            [2] = vector4(874.63, -2175.16, 30.52, 178.18),
        },
    },
    ["paycheck"] = {
        label = "Payslip Collection",
        coords = vector3(892.41, -2172.31, 32.29),
    },
    ["trashcan"] ={
        [1] = {
            name = "forumdrive",
